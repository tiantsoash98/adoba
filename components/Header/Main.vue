        ...
        <div class="container">
            <div class="row header__main-wrapper">
                <div class="header__logo-wrapper col-4">
                    <NuxtLink to="/" @click="closeHeader" aria-label="Page accueil">
                ...
                <nav class="header__large col-8">
                    <ul class="header__links callout-text">
                        ...
                        <li class="header__link">
                            <NuxtLink to="/studio" aria-label="Page le studio" @click="closeHeader">Le studio</NuxtLink>
                        </li>
                        <li class="header__link">
                            <NuxtLink to="/realisations" aria-label="Page réalisations" @click="closeHeader">Réalisations</NuxtLink>
                        </li>
                        <li class="header__link">
                            <NuxtLink to="/blog" aria-label="Page blog" @click="closeHeader">Blog</NuxtLink>
                        </li>
                        <li class="header__link">
                            <NuxtLink to="/faq" aria-label="Page FAQ" @click="closeHeader">FAQ</NuxtLink>
                        </li>
                        <li class="header__link">
                            <NuxtLink to="/jobs" aria-label="Page Jobs" @click="closeHeader">Jobs</NuxtLink>
                        </li>
                        <li>
                            <NuxtLink to="/contact" @click="closeHeader" aria-label="Page contact">
